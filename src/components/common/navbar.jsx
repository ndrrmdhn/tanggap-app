      ...
      <header className=" max-w-screen-xl  justify-between mx-auto w-full flex h-16 items-center gap-4 px-4 md:px-6">
        <nav className="hidden flex-col gap-6 text-lg font-medium md:flex md:flex-row md:items-center md:gap-5 md:text-sm lg:gap-14">
          ...
          <div className="flex flex-row gap-10">
            <Link to={"/"} className="text-white text-text16_24 transition-colors hover:underline hover:underline-offset-4">
              Home
            </Link>
            <Link
              to={"/pengaduan"}
              className="text-white text-text16_24 transition-colors hover:underline hover:underline-offset-4"
            >
              Pengaduan
            </Link>
            <Link to={"/berita"} className="text-white text-text16_24 transition-colors hover:underline hover:underline-offset-4">
              Berita
            </Link>
            <Link
              to={"/customer-service"}
