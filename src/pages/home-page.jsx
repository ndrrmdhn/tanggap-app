  ...
  return (
    <AppLayout>
      <section className="relative">
        ...
        <img src="/images/hero.svg" className="w-screen mt-[-30px] z-10 max-w-[1564px] mx-auto object-cover" alt="" srcSet="" />
        <SectionWrapper
          className={
        ...
        >
          ...
          <img src="/images/home-laptop.svg" className="max-w-[360px] max-h-[360px] object-cover" alt="" srcSet="" />
        </SectionWrapper>
      </section>
      <SectionWrapper className={"mt-[100px]"}>
        <section className="p-[50px] w-full  bg-color-2 flex items-center   shadow-xl shadow-[rgba(0,_0,_0,_0.25)] rounded-[20px] justify-between ">
          <div className="space-y-4">
            ...
            <Button onClick={() => window.location.href = '/pengaduan'} variant={"color-shadow"} className=" text-white w-[200px]">
              Selengkapnya
            </Button>
          </div>
          <img src="/images/device.svg" className="max-w-[360px] max-h-[360px] object-cover" alt="" srcSet="" />
        </section>
      </SectionWrapper>
      <SectionWrapper className={"mt-[100px] "}>
            ...
            return (
              ...
              >
                <CardHeader className="items-center h-[220px] ">
                  <img src={layanan.image} className="max-h-[200px] h-full  max-w-[200px] w-full" />
                </CardHeader>
                <CardContent className="space-y-[20px]">
                  <h1 className="text-2xl font-bold text-center">{layanan.title}</h1>
