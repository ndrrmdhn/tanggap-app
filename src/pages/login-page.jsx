        ...
        <div className="gap-6 grid pb-10">
          ...
          <div className="grid gap-9">
            ...
            <div className="w-full space-y-3">
              <Button
                onClick={() => navigate("/")}
                className="w-full h-[50px] text-[16px] leading-[24px] bg-[rgba(0,_132,_214,_1)] "
              >
                Masuk
              </Button>
              ...
              <div className=" flex justify-center">
                ...
                >
                  ...
                  <span className="text-[16px] leading-[24px] block text-slate-500">Daftar dengan Google</span>
                </Link>
              </div>
              <div className="pt-1">
